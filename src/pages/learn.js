      ...
      <div className={classnames(componentClasses.heroContainer, 'h-full')}>
        ...
        >
          <div className="h-full flex flex-col text-center mx-20">
            ...
            <p className="text-xl mt-2 mb-auto">
              Learn how dSynths works, why we exist, and how traders of equity and crypto markets
              can benefit from it.
            </p>
        ...
        >
          <div className="h-full flex flex-col text-center mx-20">
            ...
            <p className="text-xl mt-2 mb-auto">
              dSynths is developed with widespread adoption of the DEUS and Muon protocols as its
              core philosophy. To accomplish such a feat, our products are well equipped to serve
              any developer&apos;s needs.
            </p>
            <p className="text-ds-grey mb-2 text-xl">Coming Soon</p>
          </div>
        </div>
